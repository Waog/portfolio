...
export const Default: Story = {
  render: args => ({
    props: args,
    template: `
      <lib-section [background]="background" [fullWidth]="fullWidth" [noVerticalPadding]="noVerticalPadding" [printMode]="printMode">
...
export const WithBackground: Story = {
  render: args => ({
    props: args,
    template: `
      <lib-section background [printMode]="printMode">
...
export const FullWidth: Story = {
  render: args => ({
    props: args,
    template: `
      <lib-section fullWidth [printMode]="printMode">
  ...
  render: args => ({
    ...
    template: `
      <div style="background-color: #f0f0f0; padding: 20px;">
        ...
        <hr style="margin: 0;" />
        <lib-section [noVerticalPadding]="noVerticalPadding" [printMode]="printMode">
...
export const BackgroundAndFullWidth: Story = {
  render: args => ({
    props: args,
    template: `
      <lib-section background fullWidth [printMode]="printMode">
  ...
  render: args => ({
    ...
    template: `
      <lib-section
        ...
        [printMode]="printMode"
      >
        <h2>Print Mode Section</h2>
        <p>This story enables the TS-driven print layout by default.</p>
        <p>Use the controls panel to compare printMode with the regular screen layout.</p>
      </lib-section>
    `,
  }),
  args: {
